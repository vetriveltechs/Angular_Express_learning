...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2025 at 07:37 PM
...
(2, 'STAFF', 'Staff ID', 'STF-', '1004', NULL, NULL, NULL, 'Y', NULL, NULL, NULL, NULL, NULL);
...
(21, 8, 'CA', 'CA', 1, NULL, NULL, NULL, 'Y', NULL, '2025-04-21 06:29:25', NULL, '2025-04-21 06:29:25'),
(22, 8, 'HOD', 'HOD', 2, NULL, NULL, NULL, 'Y', NULL, '2025-04-21 06:29:33', NULL, '2025-04-21 06:29:33'),
(23, 9, 'I YEAR', 'I Year', 1, NULL, NULL, NULL, 'Y', NULL, '2025-04-21 06:29:52', NULL, '2025-04-21 06:29:52'),
(24, 9, 'II YEAR', 'II Year', 2, NULL, NULL, NULL, 'Y', NULL, '2025-04-21 06:30:06', NULL, '2025-04-21 06:30:06'),
(25, 7, 'STAFF', 'Staff ID', 2, NULL, NULL, NULL, 'Y', NULL, '2025-04-21 16:25:41', NULL, '2025-04-21 16:25:53');
...
(8, 'POSITION NAME', 'Position Name', '2025-03-30', '2025-03-30', 'Y', NULL, '2025-04-21 06:28:23', NULL, '2025-04-21 15:48:26'),
(9, 'ACADEMIC YEAR', 'Academic Year', '2025-03-31', '2025-03-31', 'Y', NULL, '2025-04-21 06:29:10', NULL, '2025-04-21 15:47:58');
...
CREATE TABLE `staff_details` (
  ...
  `staff_roll_number` varchar(50) DEFAULT NULL,
...
INSERT INTO `staff_details` (`staff_id`, `staff_roll_number`, `staff_name`, `department_id`, `academic_year`, `email_id`, `contact_number`, `position_name`, `active_flag`, `inactive_date`, `created_by`, `created_date`, `last_updated_by`, `last_updated_date`) VALUES
(1, 'STF-1002', 'Vetrivel', 1, 'I YEAR', 'vetriveltechs@gmail.com', '6380394289', 'CA', 'Y', NULL, NULL, NULL, NULL, NULL);
...
ALTER TABLE `staff_details`
  ...
  ADD KEY `blog_id` (`staff_id`,`academic_year`,`active_flag`,`inactive_date`,`created_by`,`created_date`,`last_updated_by`,`last_updated_date`),
  ADD KEY `industries_id` (`department_id`);
...
--
ALTER TABLE `doc_document_numbering`
  MODIFY `document_numbering_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `list_type_values`
--
ALTER TABLE `list_type_values`
  MODIFY `list_type_values_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `lov`
  MODIFY `lov_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
