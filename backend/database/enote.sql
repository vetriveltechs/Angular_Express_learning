...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 10, 2024 at 09:57 PM
...
INSERT INTO `per_user` (`user_id`, `user_type`, `user_name`, `password`, `start_date`, `end_date`, `active_flag`, `create_by`, `created_date`, `last_updated_by`, `last_updated_date`) VALUES
(1, 'PERMANENT', 'vetrivel', '$2a$10$nHaMdpzVeayfEI2zPsrwtOoJ0FTIQ2WxKbUiILBieba3uIavEYKtC', '2024-10-01', '2024-10-03', 'Y', NULL, '2024-10-09 11:01:36', NULL, '2024-10-09 11:01:36'),
(2, 'TEMPORARY', 'Naveen', '$2a$10$9OXxrLgDegccsDvlfqbYAOdVpavj6DHg9lHqffyP0s/Bg9euHdF6K', '2024-10-01', '2024-10-03', 'Y', NULL, '2024-10-09 11:02:21', NULL, '2024-10-09 11:02:21');
...
(1, 'vetrivel', 'Attur', 'Y', NULL, '2024-10-09 11:20:38', NULL, '2024-10-09 11:20:38');
...
--
ALTER TABLE `list_type_values`
  MODIFY `list_type_values_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `lov`
--
ALTER TABLE `lov`
  MODIFY `lov_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
